...
<div style="background:#f7f8fa; border-radius:8px; padding:1.1rem 1.2rem; margin:1.2rem 0; border-left:3px solid #2c5282;">
  ...
  <div style="display:flex; flex-wrap:wrap; gap:8px; align-items:center; line-height:1.9;">
    <span style="background:#fff; border:1px solid #e2e8f0; padding:5px 10px; border-radius:6px; font-size:13px;"><span style="color:#a0aec0; margin-right:4px;">1</span>Développement matériaux &amp; procédés</span>
    <span style="color:#a0aec0; font-size:13px;">→</span>
    <span style="background:#fff; border:1px solid #e2e8f0; padding:5px 10px; border-radius:6px; font-size:13px;"><span style="color:#a0aec0; margin-right:4px;">2</span>Préparation &amp; métallographie</span>
    <span style="color:#a0aec0; font-size:13px;">→</span>
    ...
    <span style="color:#a0aec0; font-size:13px;">→</span>
    <span style="background:#fff; border:1px solid #e2e8f0; padding:5px 10px; border-radius:6px; font-size:13px;"><span style="color:#a0aec0; margin-right:4px;">5</span>Modélisation numérique &amp; méthodes inverses</span>
    <span style="color:#a0aec0; font-size:13px;">→</span>
    <span style="background:#fff; border:1px solid #e2e8f0; padding:5px 10px; border-radius:6px; font-size:13px;"><span style="color:#a0aec0; margin-right:4px;">6</span>Programmation scientifique &amp; traitement de données</span>
    <span style="color:#a0aec0; font-size:13px;">→</span>
    ...
    <span style="color:#a0aec0; font-size:13px;">→</span>
    <span style="background:#fff; border:1px solid #e2e8f0; padding:5px 10px; border-radius:6px; font-size:13px;"><span style="color:#a0aec0; margin-right:4px;">8</span>Qualité, sécurité &amp; réglementation</span>
    <span style="color:#a0aec0; font-size:13px;">→</span>
    <span style="background:#fff; border:1px solid #e2e8f0; padding:5px 10px; border-radius:6px; font-size:13px;"><span style="color:#a0aec0; margin-right:4px;">9</span>Veille &amp; recherche bibliographique</span>
  </div>
</div>
...
* **Benchmark** de solutions techniques (brasage sans plomb, TLP, frittage) et formalisation de critères de choix
* Rédaction scientifique et technique : article *Acta Materialia*, manuscrit de thèse, rapports, communications en conférences internationales
* Appui scientifique à la décision technique, transposition à des environnements applicatifs
